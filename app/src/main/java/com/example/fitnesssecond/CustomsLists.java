...
public class CustomsLists extends ArrayAdapter<exercises> {
    private final Context context;
    private final ArrayList<exercises> exerciseList;

    public CustomsLists(Context context, ArrayList<exercises> exerciseList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final exercises currentExercise = exerciseList.get(position);
