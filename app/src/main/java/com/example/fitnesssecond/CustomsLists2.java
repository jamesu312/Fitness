...
public class CustomsLists2 extends ArrayAdapter<exercises2> {
    private final Context context;
    private final ArrayList<exercises2> exerciseList;

    public CustomsLists2(Context context, ArrayList<exercises2> exerciseList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final exercises2 currentExercise = exerciseList.get(position);
