...
public class CustomsListss extends ArrayAdapter<exercisess> {
    private final Context context;
    private final ArrayList<exercisess> exerciseList;

    public CustomsListss(Context context, ArrayList<exercisess> exerciseList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final exercisess currentExercise = exerciseList.get(position);
