...
public class Customslists1 extends ArrayAdapter<exercisess1> {
    private final Context context;
    private final ArrayList<exercisess1> exerciseList;

    public Customslists1 (Context context, ArrayList<exercisess1> exerciseList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final exercisess1 currentExercise = exerciseList.get(position);
