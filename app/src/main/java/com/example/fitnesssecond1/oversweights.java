...
public class oversweights extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oversweights);
        ...
        exerciseList.add(new exercisess1   ("aged 30-39", "20 seconds", 0));
        exerciseList.add(new exercisess1   ("adadaasdOVERPAR", "25 seconds", 0));
