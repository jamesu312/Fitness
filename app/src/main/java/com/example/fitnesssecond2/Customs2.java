...
public class Customs2 extends ArrayAdapter<exercisess2> {
    private final Context context;
    private final ArrayList<exercisess2> exerciseList;

    public Customs2(Context context, ArrayList<exercisess2> exerciseList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final exercisess2 currentExercise = exerciseList.get(position);
