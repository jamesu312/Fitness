...
public class normsweight extends AppCompatActivity {
    private static final int REQUEST_CODE_WRITE_STORAGE_PERMISSION = 101;

    private ListView listView;
    private Customs adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseList.add(new exercisess ("normsweight", "25 seconds", 0));
        ...
        adapter = new Customs(this, exerciseList);
