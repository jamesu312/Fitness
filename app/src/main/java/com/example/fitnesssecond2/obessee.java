...
public class obessee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseList.add(new exercisess2    ("aged 30-40", "20 seconds", 0));
        exerciseList.add(new exercisess2        ("overweights badi", "25 seconds", 0));
        ...
        adapter = new Customs2 (this, exerciseList);
