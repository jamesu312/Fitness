...
import com.example.fitnesssecond1.exercisess2;
...
public class oversweightss extends AppCompatActivity {
    private static final int REQUEST_CODE_WRITE_STORAGE_PERMISSION = 101;

    private ListView listView;
    private Customs1 adapter;
    private ArrayList<exercisess1> exerciseList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oversweightss);
        ...
        exerciseList.add(new exercisess1    ("aged 30-40", "20 seconds", 0));
        exerciseList.add(new exercisess1    ("overweights badi", "25 seconds", 0));
        exerciseList.add(new exercisess1    ("Jumping Jacks", "25 seconds", 0));
        exerciseList.add(new exercisess1    ("Jogging", "500meters", 0));
        exerciseList.add(new exercisess1    ("Standing Knee Raises", "50 reps for both sides", 0));
        exerciseList.add(new exercisess1    ("Squats", "25 reps", 0));
        ...
        for (String exerciseDataString : exerciseDataSet) {
            ...
            if (exerciseD.length == 3) {
                ...
                for (exercisess1 exercise : exerciseList) {
        ...
        adapter = new Customs1  (this, exerciseList);
