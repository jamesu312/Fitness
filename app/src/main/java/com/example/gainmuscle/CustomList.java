...
public class CustomList extends ArrayAdapter<ExerciseD> {
    private final Context context;
    private final ArrayList<ExerciseD> exerciseList;

    public CustomList(Context context, ArrayList<ExerciseD> exerciseList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final ExerciseD currentExercise = exerciseList.get(position);
