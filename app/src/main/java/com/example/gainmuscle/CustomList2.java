...
public class CustomList2 extends ArrayAdapter<ExerciseD2> {
    private final Context context;
    private final ArrayList<ExerciseD2> exerciseList;

    public CustomList2(Context context, ArrayList<ExerciseD2> exerciseList) {
        super(context, R.layout.item_list2, exerciseList);
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listItem == null) {
            ...
            listItem = inflater.inflate(R.layout.item_list2, parent, false);
        }

        final ExerciseD2 currentExercise = exerciseList.get(position);
