...
public class Obese extends AppCompatActivity {
    ...
    private CustomList2 adapter;
    private ArrayList<ExerciseD2> exerciseList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseList.add(new ExerciseD2 ("Push kjkook", "20 seconds", 0));
        exerciseList.add(new ExerciseD2 ("GOGOGOGOGOGOG", "25 seconds", 0));
        exerciseList.add(new ExerciseD2 ("Jumpingasdada Jacks", "25 seconds", 0));
        exerciseList.add(new ExerciseD2 ("Jogging", "500meters", 0));
        exerciseList.add(new ExerciseD2 ("Standing Knee Raises", "50 reps for both sides", 0));
        exerciseList.add(new ExerciseD2 ("Squats", "25 reps", 0));
        ...
        for (String exerciseDataString : exerciseDataSet) {
            String[] exerciseD2 = exerciseDataString.split("\\|");
            if (exerciseD2  .length == 3) {
                String exerciseName = exerciseD2[0];
                String additionalText = exerciseD2[1];
                int repetitions = Integer.parseInt(exerciseD2[2]);

                // Find and update the corresponding ExerciseData object
                for (ExerciseD2 exercise : exerciseList) {
        ...
        adapter = new CustomList2(this, exerciseList);
