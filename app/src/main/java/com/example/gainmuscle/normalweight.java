...
public class normalweight extends AppCompatActivity {
    ...
    private ArrayList<ExerciseD> exerciseList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_normalweight2);
        ...
        exerciseList.add(new ExerciseD("Push kjkook", "20 seconds", 0));
        exerciseList.add(new ExerciseD("Plank", "25 seconds", 0));
        exerciseList.add(new ExerciseD("Jumping Jacks", "25 seconds", 0));
        exerciseList.add(new ExerciseD("Jogging", "500meters", 0));
        exerciseList.add(new ExerciseD("Standing Knee Raises", "50 reps for both sides", 0));
        exerciseList.add(new ExerciseD("Squats", "25 reps", 0));
        ...
        for (String exerciseDataString : exerciseDataSet) {
            ...
            if (exerciseD.length == 3) {
                ...
                for (ExerciseD exercise : exerciseList) {
        ...
        adapter = new CustomList(this, exerciseList);
