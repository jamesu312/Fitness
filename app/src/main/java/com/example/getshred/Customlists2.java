...
public class Customlists2 extends ArrayAdapter<Exercise2> {
    private final Context context;
    private final ArrayList<Exercise2> exerciseList;

    public Customlists2 (Context context, ArrayList<Exercise2> exerciseList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final Exercise2 currentExercise = exerciseList.get(position);
