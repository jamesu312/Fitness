...
public class Obesee extends AppCompatActivity {
    private static final int REQUEST_CODE_WRITE_STORAGE_PERMISSION = 101;

    private ListView listView;
    private CustomLists1 adapter;
    private ArrayList<Exercise1> exerciseList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_obesee);
        ...
        exerciseList.add(new Exercise1("Pushasdadads", "20 seconds", 0));
        exerciseList.add(new Exercise1("asdadadsa", "25 seconds", 0));
        exerciseList.add(new Exercise1("Jumping Jacks", "25 seconds", 0));
        exerciseList.add(new Exercise1("Jogging", "500meters", 0));
        exerciseList.add(new Exercise1("Standing Knee Raises", "50 reps for both sides", 0));
        exerciseList.add(new Exercise1("Squats", "25 reps", 0));
        ...
        for (String exerciseDataString : exerciseDataSet) {
            ...
            if (exerciseD.length == 3) {
                ...
                for (Exercise1 exercise : exerciseList) {
        ...
        adapter = new CustomLists1(this, exerciseList);
