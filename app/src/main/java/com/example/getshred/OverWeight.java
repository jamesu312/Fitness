...
public class OverWeight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseList.add(new Exercise2 ("Push sdsdsds", "20 seconds", 0));
        exerciseList.add(new Exercise2 ("sdsdsds", "25 seconds", 0));
        exerciseList.add(new Exercise2 ("sds Jacks", "25 seconds", 0));
        exerciseList.add(new Exercise2 ("Jogging", "500meters", 0));
        exerciseList.add(new Exercise2 ("Standing Knee Raises", "50 reps for both sides", 0));
        exerciseList.add(new Exercise2 ("Squats", "25 reps", 0));
